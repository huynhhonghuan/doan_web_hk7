...
@section('content')
    <p class="pt-3">
        <a href="{{ route('congtacvientruyen.truyen.create') }}" class="btn btn-warning"><i class="fa-light fa-plus"></i> Thêm
            mới</a>
        ...
        <a href="{{ route('congtacvientruyen.truyen.xuat') }}" class="btn btn-success"><i class="fa-light fa-download"></i>
            Xuất
            ra Excel</a>

        <a href="{{ route('congtacvientruyen.truyen.hinh') }}" class="btn btn-danger"><i class="fa-light fa-download"></i>
            Xuất
            ra hình ảnh</a>
    </p>
