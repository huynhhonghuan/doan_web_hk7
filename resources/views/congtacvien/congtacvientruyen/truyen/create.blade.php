...
@endsection
@section('content')
    <form action="{{ route('congtacvientruyen.truyen.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group" data-select2-id="29">
                ...
                <select class="form-select select2 select2-hidden-accessible" style="width: 100%; height: 150px;"
                    data-select2-id="1" tabindex="-1" aria-hidden="true" name="theloai_id[]" multiple="multiple">
