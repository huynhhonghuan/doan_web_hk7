    ...
    <div class="row justify-content-center">
        <div class="col-md-3 bg-danger" style="margin: 10px; height: 150px;">
            <div class="row h-100">
                ...
                <div class="col-4 mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-columns-gap" viewBox="0 0 16 16">
        ...
        <div class="col-sm-3 bg-success" style="margin: 10px;">
            <div class="row h-100">
                <div class="col-8 py-4">
                    <div class="text-white px-3" style="font-size: 40px;">
                        <span style="font-weight: bold">{{$truyenchoduyet}}</span>
                        <br>
                    </div>
                ...
                <div class="col-4 mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-file-earmark-richtext" viewBox="0 0 16 16">
            ...
            <div class="row h-100">
                <div class="col-8 py-4">
                    <div class="text-dark px-3" style="font-size: 40px;">
                        <span style="font-weight: bold">{{$truyenduocduyet}}</span>
                        <br>
                    </div>
