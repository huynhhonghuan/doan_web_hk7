...
@section('content')
    <p class="mt-3">
        <a href="{{route('congtacvientruyen.truyenchitiet.create')}}" class="btn btn-info"><i class="fa-light fa-plus"></i> Thêm mới</a>
        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-default">
            Nhập từ Excel
        </button>
        <a href="{{ route('congtacvientruyen.truyenchitiet.xuat') }}" class="btn btn-success"><i class="fa-light fa-download"></i> Xuất
            ra Excel</a>
        <a href="{{ route('congtacvientruyen.truyenchitiet.hinh') }}" class="btn btn-danger"><i class="fa-light fa-download"></i> Xuất
            ra hình ảnh</a>
    </p>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form onclick="return confirm('Bạn có muốn xóa không?');" class="d-inline-block"
                                action="{{ route('congtacvientruyen.truyenchitiet.destroy', [$truyenchitiet]) }}" method="post">
                                @csrf
                                @method('delete')
