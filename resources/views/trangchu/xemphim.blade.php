                        ...
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a
                                    ...
                                    » <span><a
                                        ...
                                        » <span class="breadcrumb_last"
                                            aria-current="page">{{ $movie->ten }}</span></span></span></span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="clearfix wrap-content">
                    ...
                    <div class="title-block">
                        ...
                        <div class="title-wrapper-xem full">
                            <h1 class="entry-title"><a href="" title="{{ $movie->ten }}"
                                    class="tl">{{ $movie->ten }} @if ($movie->danhmuc->slug == 'phim-bo')
                                        tập {{ $episode->tap }}
                                    @else
                                        - Full
                                    @endif
                            ...
                            <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                                <div class="halim-server">
                                    <ul class="halim-list-eps">
                                        @foreach ($movie->tapphim as $key => $epp)
                                            <a href="{{ url('xem-phim/' . $movie->slug . '/tap-' . $epp->tap) }}">
                                                <li class="halim-episode"><span
                                                        ...
                                                        data-title="Xem phim {{ $movie->ten }} - Tập {{ $epp->tap }} - Be Together - vietsub + Thuyết Minh"
                                                        data-h1="{{ $movie->ten }} - tập {{ $epp->tap }}">{{ $epp->tap }}</span>
                                                </li>
                                            </a>
                                        @endforeach
                                    </ul>
