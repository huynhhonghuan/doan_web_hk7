        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            ...
            <section>
                <div class="section-bar clearfix">
                    <h1 class="section-title"><span>{{ $genre_slug->tentheloai }} - phim</span></h1>
                </div>
                <div class="section-bar clearfix">
                    <div class="row">
            ...
            <section>
                <div class="section-bar clearfix">
                    <h1 class="section-title"><span>{{ $genre_slug->tentheloai }} - truyện</span></h1>
                </div>
                <div class="section-bar clearfix">
                    <div class="row">
