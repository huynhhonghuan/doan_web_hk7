...
@section('content')
    <p class="mt-3">
        <a href="{{ route('admin.theloai.create') }}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('admin.theloai.xuat') }}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            @if (empty($danhsach) == false)
                @foreach ($danhsach as $key => $theloai)
                    <tr>
                        ...
                        <td>{{ $theloai->mota }}</td>
                        @if ($theloai->khoa == 1)
                            <td><a href="{{ route('admin.theloai.khoa', ['theloai' => $theloai]) }}"><span
