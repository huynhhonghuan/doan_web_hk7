...
@section('content')
    <p class="mt-3">
        <a href="{{ route('admin.vaitro.create') }}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('admin.vaitro.xuat') }}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg"
