...
@section('content')
    <p class="mt-3">
        <a href="{{ route('admin.truyen.create') }}" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('admin.truyen.xuat') }}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            Xuất ra Excel</a>
        <a href="{{ route('admin.truyen.hinh') }}" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg"
