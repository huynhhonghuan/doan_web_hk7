...
use App\Exports\Congtacvientruyen\TruyenChiTietExport;
use App\Http\Controllers\Controller;
use App\Http\Requests\Congtacvientruyen\TruyenChiTietRequest;
use App\Imports\Congtacvientruyen\TruyenChiTietImport;
...
class TruyenChiTietController extends Controller
{
    ...
    public function store(TruyenChiTietRequest $request)
    {
        ...
        return redirect()->route('congtacvientruyen.truyenchitiet.index');
    }
    ...
    public function edit(TruyenChiTiet $truyenchitiet)
    {
        ...
        $truyen = Truyen::all();
        return view('congtacvien.congtacvientruyen.truyenchitiet.edit', compact('title', 'truyen', 'truyenchitiet'));
    }
