...
class TrangChuController extends Controller
{
    ...
    public function category($slug)
    {
        ...
        //Đánh giá cho Phim sidebar
        $movie_rating = $movie_hot->pluck('id')->toArray();
        $rating = DanhGiaPhim::whereIn('phim_id', $movie_rating)->avg('danhgia');
        $rating_sidebar = round($rating);
        ...
        return view('trangchu.danhmuc', compact('category', 'genre', 'country', 'cate_slug', 'movie', 'movie_trailersidebar', 'movie_hot', 'rating_sidebar'));
    }
    public function theloai($slug)
    {
        ...
        return view('trangchu.theloai', compact('category', 'genre', 'country', 'genre_slug', 'movie', 'movie_trailersidebar', 'movie_hot', 'rating_sidebar'));
    }
    public function quocgia($slug)
    {
        ...
        //Lấy phim có chất lượng trailer
        $movie_trailersidebar = Phim::where('chatluong', 2)->where('khoa', 1)->take(15)->get();
        return view('trangchu.quocgia', compact('category', 'genre', 'country', 'country_slug', 'movie', 'movie_trailersidebar', 'movie_hot', 'rating_sidebar'));
    }
    public function phim()
    {
        ...
        return view('trangchu.phims', compact('category', 'genre', 'country', 'category_home', 'movie_hot', 'movie_trailersidebar', 'rating_sidebar'));
    }
    ...
    public function movie($slug)
    {
        ...
        return view('trangchu.phim', compact('category', 'genre', 'country', 'movie', 'movie_related', 'movie_trailersidebar', 'episode', 'episode_first', 'episode_cur_list_count', 'genre_id', 'rating', 'count_rating', 'movie_hot', 'rating_sidebar'));
    }
    ...
    public function watch($slug, $tap)
    {
        ...
        return view('trangchu.xemphim', compact('category', 'genre', 'country', 'movie', 'movie_trailersidebar', 'episode', 'tapphim', 'movie_related', 'movie_hot', 'rating_sidebar'));
    }
    ...
    public function search()
    {
        if (isset($_GET['search'])) {
            ...
            return view('trangchu.timkiem', compact('category', 'genre', 'country', 'search', 'movie', 'movie_trailersidebar', 'movie_hot', 'rating_sidebar'));
        } else {
            return redirect()->to('/');
        }
    }
